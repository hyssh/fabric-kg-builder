...
- **Integrated raw-text windows** — `domain window-run` carries domain/questions and the current schema into extraction, evaluates proposals at batch boundaries, and connects complete runs to explicit approval and candidate replay
