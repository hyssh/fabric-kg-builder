...
ENTITIES_SCHEMA = pa.schema([
    ...
    pa.field("audit_reason_codes", _LIST_STR, nullable=True),
    pa.field("proposal_approval_json", _STR, nullable=True),
...
RELATIONSHIPS_SCHEMA = pa.schema([
    ...
    pa.field("assertion_state", _STR, nullable=True),
    pa.field("processing_status", _STR, nullable=True),
    pa.field("semantic_lane", _STR, nullable=True),
    pa.field("semantic_contract_hash", _STR, nullable=True),
    pa.field("reason_codes", _LIST_STR, nullable=True),
    pa.field("candidate_evidence_json", _STR, nullable=True),
    pa.field("resolved_source_type_id", _STR, nullable=True),
    pa.field("resolved_target_type_id", _STR, nullable=True),
    pa.field("source_inheritance_path", _LIST_STR, nullable=True),
    pa.field("target_inheritance_path", _LIST_STR, nullable=True),
    pa.field("validation_authority", _STR, nullable=True),
    pa.field("retry_eligible", _BOOL, nullable=True),
    pa.field("prompt_version", _STR, nullable=True),
    pa.field("model_version", _STR, nullable=True),
    pa.field("source_profile_hash", _STR, nullable=True),
    pa.field("proposal_hash", _STR, nullable=True),
    pa.field("terminal_bucket", _STR, nullable=True),
    pa.field("canonical_row_hash", _STR, nullable=True),
    pa.field("deduplicated_occurrence_count", _INT32, nullable=True),
...
EVIDENCE_SCHEMA = pa.schema([
    ...
    pa.field("text_unit_id", _STR, nullable=True),
    pa.field("span_start", _INT32, nullable=True),
    pa.field("span_end", _INT32, nullable=True),
    pa.field("source_content_hash", _STR, nullable=True),
    pa.field("runner_verified", _BOOL, nullable=True),
    pa.field("content_hash", _STR, nullable=False),
    pa.field("created_at", _TS, nullable=False),
    *_COMMON_LINEAGE_FIELDS,
])
